...
| `SprintN/DailyScrum/` | Günlük scrum kanıtı (WhatsApp/Slack thread screenshot) | Daily Scrum (2) | **her gün** |
...
- **Toplantı (numaralı sync):** `sprint1-meeting-01-2026-06-19.png` · `sprint1-meeting-02-2026-06-26.png` …
- **Tören (tip-tabanlı):** `sprint1-planning-2026-06-30.png` · `sprint1-review-2026-07-05.png` · `sprint1-retro-2026-07-05.png`
...
## 📅 Daily nasıl kaydedilir (araç-bağımsız)

Her **geliştirme yapılan gün**, WhatsApp/Slack daily kanalına yazılı 3 satır (sabit saat yok):
- **Dün:** ne yaptım (issue # + kısa) · **Bugün:** ne yapacağım · **Blocker:** engel var mı

**Kaydı:** günün thread'inin **ekran görüntüsü** → `SprintN/DailyScrum/daily-YYYY-MM-DD.png` + bir satır → `SprintN/DailyScrum/daily-scrum-log.md`.

**"AI aracıma daily'mi yaz" dediğinde:**

| AI **yapar** | İnsan **yapar** |
|---|---|
| O günkü commit/PR'lardan **dün/bugün/blocker özeti** taslaklar → `daily-scrum-log.md`'ye satır ekler | **Ekran görüntüsünü alır** (AI screenshot/ikili dosya **üretemez**) + commit'ler |

> Araç metni hazırlar, görseli sen koyarsın. Araç-bağımsız: Claude/Codex/Gemini/Kiro hepsi `daily-scrum-log.md`'yi günceller.
