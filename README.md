...
> **Bu bölüm tek-duraktır:** her sprintin 6 zorunlu başlığı ve kanıt görselleri aşağıdadır — klasörler yalnızca dosya deposudur. Kanıt haritası: [`ProjectManagement/README.md`](ProjectManagement/README.md).

**Backlog board:** [GitHub Projects — grup54 Sprint Board](https://github.com/users/FatihErenCetin/projects/1) *(public — issue/PR durumundan kendiliğinden dolar, ürünün kendi vaadinin dogfood'u)*
...
- **Daily ritmi = her gün 22:00, async** (WhatsApp; ileride Slack'e taşınması planlanıyor).
...
| **WhatsApp** | Günlük scrum (daily, 22:00 async) — kanıt `ProjectManagement/Sprint1/DailyScrum/` `[SM doğrula]` |
...
Daily scrum'ları **WhatsApp** üzerinden, **her gün 22:00**'de **asenkron** olarak yürüttük (yalnızca geliştirme yapılan günler). Asenkron format, ekibin farklı saat dilimlerinde/uygunlukta çalışmasına izin verdi; herkes günü kapatırken üç soruyu yazılı geçti:

- Dün ne yaptım?
- Bugün ne yapacağım?
- Önümde engel (blocker) var mı?

**Cadence:** Günlük, 22:00 (async) · yalnızca geliştirme yapılan günlerde.

> **Not:** Daily kanalını Sprint ilerledikçe WhatsApp'tan **Slack**'e taşıma kararı aldık (gerekçe: thread'li kanal yapısı + entegrasyon olanakları). Sprint 1 boyunca aktif platform **WhatsApp** olmuştur; Slack'e geçiş Sprint 2'de planlanıyor.
...
- Görüntülerdeki saat damgaları 22:00 async ritmiyle tutarlı mı?
...
7. **Cadence = günlük 22:00 async** — daily scrum WhatsApp üzerinden async (ileride Slack'e taşıma opsiyonu açık).
...
- **Daily disiplini.** WhatsApp üzerinden 22:00 async daily ritmi tutuldu. <!-- SM: gerçekleşme oranı + kanıt görselleri → ProjectManagement/Sprint1/DailyScrum/ [SM doğrula] -->
...
| R5 | **Daily disiplinini koru (22:00 async)** + kanıtı her gün anında ilgili klasöre commit'le | SM Esma | Her gün | `ProjectManagement/Sprint2/DailyScrum/` günlük dolu (ASCII, ISO tarihli) |
...
## 🏃 Sprint 2 *(6 – 19 Temmuz 2026)* — devam ediyor

**Hedef:** kusursuz çakışma radarı — uçtan uca AI çekirdeği (ingest → embeddings → LLM judge → **false-positive kalibrasyonu/eval**) + web radar sayfası. *(Sprint sonunda 6 başlık burada doldurulacak: Backlog Dağıtma Mantığı · Daily Scrum · Sprint Board · Ürün Durumu · Review · Retrospective + burndown.)*

## 🏃 Sprint 3 *(20 Temmuz – 2 Ağustos 2026)*

**Plan:** kabuk (board/ask) · scope-drift dedektörü · MCP araçları · hosted demo · 3 dk video. *(Sprint sonunda 6 başlık burada doldurulacak.)*
