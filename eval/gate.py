...
altına düşerse exit 1 ile CI'ı kırar. Dedektör/judge regresyonuna karşı
otomatik koruma.
...
# Kalibre tabanlar. #18 operasyon noktası: precision=1.0, F0.5=0.9375, FP=0.
# Taban = mevcut değerin altında güvenlik payıyla. Precision sıkı çünkü FP #1
# risk: TP=6/FP=0 noktasında tek FP bile precision'ı 6/7=0.857'ye düşürür,
# yani 0.90 tabanı tek bir yeni yanlış-pozitifi bile yakalar.
MIN_PRECISION = 0.90
MIN_F05 = 0.85
...
def evaluate_gate(
    ...
    *,
    ...
    """Tabanları geçemeyen metrikleri döner (boş liste = geçti).
